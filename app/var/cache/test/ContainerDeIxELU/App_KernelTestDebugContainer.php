...
class App_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Application\\v1\\Controller\\HistoricalQuotesController' => 'getHistoricalQuotesControllerService',
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Application\\v1\\Controller\\HistoricalQuotesController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        $container->privates['monolog.handler.file'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/error.log'), 'error', true, NULL, false);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'finance_data_api_key' => $container->getEnv('RAPIDAPI_KEY'),
